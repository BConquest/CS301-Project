...
class page_RegisterDeliverer(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller

        self.lbl_Title = tk.Label(self, text="Register Deliverer ")
        ...
        self.txt_Error.set("Registering Deliverer")
        ...
        self.lbl_Error.grid(row=4,column=2,columnspan=3,rowspan=2)
    ...
    def Register(self):
        ...
        data_query = (self.txt_UName.get(), self.txt_1Pass.get(), "deliverer",
